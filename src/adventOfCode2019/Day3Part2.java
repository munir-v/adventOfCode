...
//	static ArrayList<String> part2 = new ArrayList<String>(Arrays.asList("L1003","D960","L10","D57","R294","U538","R867","D426","L524","D441","R775","U308","R577","D785","R495","U847","R643","D895","R448","U685","L253","U312","L312","U753","L89","U276","R799","D923","L33","U595","R400","U111","L664","D542","R171","U709","L809","D713","L483","U918","L14","U854","L150","D69","L158","D500","L91","D800","R431","D851","L798","U515","L107","U413","L94","U390","L17","U221","L999","D546","L191","U472","L568","U114","L913","D743","L713","D215","L569","D674","L869","U549","L789","U259","L330","D76","R243","D592","L646","U880","L363","U542","L464","D955","L107","U473","R818","D786","R852","U968","R526","D78","L275","U891","R480","U991","L981","D391","R83","U691","R689","D230","L217","D458","R10","U736","L317","D145","R902","D428","R344","U334","R131","D739","R438","D376","L652","U304","L332","D452","R241","D783","R82","D317","R796","U323","R287","D487","L302","D110","R233","U631","R584","U973","L878","D834","L930","U472","R120","U78","R806","D21","L521","U988","R251","D817","R44","D789","R204","D669","R616","D96","R624","D891","L532","U154","R438","U469","R785","D431","R945","U649","R670","D11","R840","D521","L235","D69","L551","D266","L454","U807","L885","U590","L647","U763","R449","U194","R68","U809","L884","U962","L476","D648","L139","U96","L300","U351","L456","D202","R168","D698","R161","U834","L273","U47","L8","D157","L893","D200","L454","U723","R886","U92","R474","U262","L190","U110","L407","D723","R786","D786","L572","D915","L904","U744","L820","D663","R205","U878","R186","U247","L616","D386","R582","U688","L349","D399","R702","U132","L276","U866","R851","D633","R468","D263","R678","D96","L50","U946","R349","D482","R487","U525","R464","U977","L499","D187","R546","U708","L627","D470","R673","D886","L375","U616","L503","U38","L775","D8","L982","D556","R159","U680","L124","U777","L640","D607","R248","D671","L65","D290","R445","U778","L650","U679","L846","D1","L769","U659","R734","D962","R588","U178","R888","D753","R223","U318","L695","D586","R430","D61","R105","U801","R953","U721","L856","U769","R937","D335","R895"));
	...
	public static void line2() {
		for (int i=0; i<part2.size(); i++) {
			String current = part2.get(i); //the letter part
			String stringDist = current.substring(1,current.length()); //the number part
			int dist = Integer.parseInt(stringDist); //turn the distance into a number
		
			if(current.substring(0,1).equalsIgnoreCase("R")) { //right
				 for (int j=0; j<=dist; j++) {
					values2.add(horDist2+j); //add all the coordinates of the distance
					values2.add(verDist2);
					totalDist2++;
				 }
				 horDist2+=dist; //add the distance to the total
			}
			if(current.substring(0,1).equalsIgnoreCase("L")) { //left
				 for (int j=0; j<=dist; j++) {
					values2.add(horDist2-j);
					values2.add(verDist2);
					totalDist2++;
				 }
				 horDist2-=dist;
			...
			if(current.substring(0,1).equalsIgnoreCase("U")) { //up 
				for (int j=0; j<=dist; j++) {
					values2.add(horDist2);
					values2.add(verDist2+j);
					totalDist2++;
				}
				verDist2+=dist;
			}
	...
	public static ArrayList<Integer> testAll() {
		ArrayList<Integer> positions = new ArrayList<Integer>(); //array to be filled with all overlapping wire positions
		for (int i=0; i<values1.size()/2; i+=2) {
			for (int j=0; j<values1.size()/2; j+=2) {
				if(values1.get(i).equals(values2.get(j))  //test all coordinates for matches
				&& values1.get(i+1).equals(values2.get(j+1))) {
					int pos = values1.get(i) + values1.get(i+1); //add x+y (Manhattan distance)
					positions.add(pos);
					System.out.println("totalDist1: " + totalDist1);
					System.out.println("totalDist2: " + totalDist2);
				}
			}
		}
		return positions;
